...
articles.forEach(article => 
    {
        ...
        badgeDiv.textContent = "Nouveauté";
    
        let titleLink = document.createElement('a');
        titleLink.className = "text-decoration-none link-dark stretched-link";
        titleLink.href = "detail.php"; //HREF a modifié et dynamiser par PHP selon les ID
        titleLink.innerHTML = `<h5 class="card-title mb-3">${article.article}</h5>`;
        ...
        priceDiv.innerHTML = `<div class="fw-bold">Prix : ${article.prix}</div>`;
